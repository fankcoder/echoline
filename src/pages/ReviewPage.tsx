...
export default function ReviewPage() {
  ...
  const finish = async () => { if (!deck.length) return; await recordReview(groupIndex, deck.map((item) => ({ word: item.word, kind: item.kind }))); notify(`第 ${groupIndex + 1} 组复习已记录`); reshuffle(); };
